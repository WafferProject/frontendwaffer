...
const [businessForm , setBusinessForm] = React.useState({tax_registration_number :"t"  , password:"" });
const [consumerForm , setConsumerForm] = React.useState({email :""  , password:"" });
    ...
    isBuisness ? setBusinessForm(newField) : setConsumerForm(newField);
        ...
        const handleSubmit = (event) => {
          ...
          axios
            .post(
              url,
             signInObj , {withCredentials:true}
            )
            .then((response) => {
              console.log(
